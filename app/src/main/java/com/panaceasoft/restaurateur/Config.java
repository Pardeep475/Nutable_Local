...
public class Config extends Application{
    ...
    public static final String APP_API_URL = "https://nutable.io/administrator/index.php";
    //public static final String APP_API_URL = "http://192.168.1.5:8888/restaurateur-admin/index.php";


    public static final String APP_IMAGES_URL = "https://nutable.io/administrator/uploads/";
    ...
    public static final String POST_FB_LOGIN = "/rest/appusers/fb_login";
    ...
    public static final String POST_USER_VERIFY = "/rest/smsnotifications/verify_code/";

    public static final String POST_USER_RESEND = "/rest/smsnotifications/verify_phone/";
    ...
    public static final String GET_SHOP_ALL = "/rest/items/getmerge/shop_id/";

    public static final String CALL_WAITER  = "/rest/callwaiter/add_response/";

    public static final String TABLE_LOGIN  = "/rest/tables/add_response/";

    public static final String TABLE_LOGOUT = "/rest/tables/remove_user_on_table/";
