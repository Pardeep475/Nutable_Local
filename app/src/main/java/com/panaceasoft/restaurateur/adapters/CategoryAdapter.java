...
public class CategoryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof MyViewHolder) {
            ...
            if(categoryRowDataList.get(position).getSubCatId().equalsIgnoreCase("")) {
                ((MyViewHolder) holder).laySubCategory.setVisibility(View.GONE);
                ...
                ((MyViewHolder) holder).laySubCategory.setVisibility(View.VISIBLE);

                ((MyViewHolder) holder).name.setText(categoryRowDataList.get(position).getSubCatName());
                ((MyViewHolder) holder).name.startAnimation(AnimationUtils.loadAnimation(this.activity, R.anim.fade_in));

                ((MyViewHolder) holder).desc.startAnimation(AnimationUtils.loadAnimation(this.activity, R.anim.fade_in));

                ((MyViewHolder) holder).icon.destroyDrawingCache();

                MyViewHolder myViewHolder = (MyViewHolder) holder;

                Utils.bindImage(myViewHolder.name.getContext(), p, myViewHolder.icon, categoryRowDataList.get(position).getSubCatImage(), 2);
            }
        } else {
    ...
    public static final class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        RelativeLayout layCategory, laySubCategory;
        ...
        MyViewHolder(View itemView) {
            ...
            laySubCategory  = itemView.findViewById(R.id.lay_subcategory);
