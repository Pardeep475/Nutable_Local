...
//
    ...
    public void doSearch(final String URL, String searchKeyword) {
...
//            getActivity().getWindow().setLayout(ViewGroup.LayoutParams.MATCH_PARENT,ViewGroup.LayoutParams.MATCH_PARENT);
        ...
        TextView textSearch       =  dialog.findViewById(R.id.text_search);
        TextView textCancel       =  dialog.findViewById(R.id.text_search_close);
        final EditText edtSearch  =  dialog.findViewById(R.id.edit_search);
        ...
        textSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!edtSearch.getText().toString().trim().equalsIgnoreCase("")) {
                    ...
                    final String URL = Config.APP_API_URL + Config.SHOP_SEARCH_BY_KEYWORD;
                    Utils.psLog(URL);
                    doSearch(URL, edtSearch.getText().toString().trim());
                } else {
                    showFailPopup(getResources().getString(R.string.enter_search_error));
                }
            }
        });
...
//            getActivity().getWindow().setLayout(ViewGroup.LayoutParams.MATCH_PARENT,ViewGroup.LayoutParams.MATCH_PARENT);
            ...
            textMsg.setText(getResources().getString(R.string.result_no_found_message));
