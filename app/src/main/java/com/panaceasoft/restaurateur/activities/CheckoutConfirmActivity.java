    ...
    private void loadBasketData(String paymentOption) {
        ...
        for (BasketData basketData : basket) {
            ...
            try {
                ...
                jsonObject.put("table_id", pref.getString("table_id", ""));
...
//            getActivity().getWindow().setLayout(ViewGroup.LayoutParams.MATCH_PARENT,ViewGroup.LayoutParams.MATCH_PARENT);
        ...
        textMsg.setText(getResources().getString(R.string.order_success));
...
//            getActivity().getWindow().setLayout(ViewGroup.LayoutParams.MATCH_PARENT,ViewGroup.LayoutParams.MATCH_PARENT);
        ...
        textMsg.setText(getResources().getString(R.string.order_fail));
    ...
    private void doTableSubmit(String postURL, HashMap<String, String> params) {
        ...
        VolleySingleton.getInstance(CheckoutConfirmActivity.this).addToRequestQueue(req);
