...
public class DetailActivity extends BaseActivity {
    ...
    private ImageView imgQtyAdd;
    private ImageView imgQtyRemove;

    private ProgressDialog prgDialog;

    List<TableUserData.Datum> tableUserList;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        Log.e("heredetailONT","heredetailONT");
        try {
            if (requestCode == 1) {
    ...
    public void onBackPressed() {
        ...
        try {
            ...
            Log.e("heredetailOnACt","heredetailOnACt1");
            finish();
...
//            Utils.unbindDrawables(mainLayout);
    ...
    private void initData() {
        ...
        try {
            ...
            try {
                shopLat = getIntent().getDoubleExtra("selected_shop_lat", 0.0);
                shopLng = getIntent().getDoubleExtra("selected_shop_lng", 0.0);
            } catch (Exception e) {
                e.printStackTrace();
            }
            ...
            prgDialog = new ProgressDialog(DetailActivity.this);
    ...
    private void initUI() {
        ...
        try {
            ...
            imgQtyAdd      =  findViewById(R.id.img_qty_add);
            imgQtyRemove   =  findViewById(R.id.img_qty_remove);

            imgQtyAdd.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    if(!editTextQty.getText().toString().trim().equalsIgnoreCase("")) {
                        int qtyVal = Integer.parseInt(editTextQty.getText().toString().trim());
                        editTextQty.setText(""+(qtyVal + 1));
                    } else {
            ...
            imgQtyRemove.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    if(!editTextQty.getText().toString().trim().equalsIgnoreCase("")) {
                        int qtyVal = Integer.parseInt(editTextQty.getText().toString().trim());
    ...
    private void bindPrice() {
        try {
            if (GlobalData.itemData != null) {
                ...
                txtPrice.setText(""+Utils.format(unitPrice) + currencySymbol);
...
////                        .into(detailImage);
                ...
                Utils.bindImageRound(this, p, detailImage, GlobalData.itemData.images.get(0), 2);
            }
        } catch (Exception e) {
        ...
        try {
            if (GlobalData.itemData != null) {
                if (GlobalData.itemData.discount_type_id == 0) {
                    ...
                    txtPrice.setText(""+Utils.format(calculatedPrice) + GlobalData.itemData.currency_symbol);
    ...
    private void bindAttribute() {
        ...
        try {
            if (spinnerCreation == 0 && GlobalData.itemData != null) {
                ...
                TextView textAttr = findViewById(R.id.choose_attr);
                ...
                if (itemAttributeData != null) {
                    ...
                    if (itemAttributeData.size() > 0) {
                        ...
                        textAttr.setVisibility(View.VISIBLE);

                        for (int i = 0; i < itemAttributeData.size(); i++) {
                            final Spinner spin = myAct.getSpinner();
                            ...
                            if (itemAttributeData.get(i) != null) {
                                if (itemAttributeData.get(i).details != null) {
                                    ...
                                    spin.setOnItemSelectedListener(new Spinner.OnItemSelectedListener() {
                                        ...
                                        @Override
                                        public void onItemSelected(AdapterView<?> spinner1, View view, int position, long l) {

                                            if (position != 0) {
                                                AttributeRowData attribute;
                                                if (!(spin.getSelectedItem() == null)) {
                                                    attribute = (AttributeRowData) spin.getSelectedItem();
...
//                                                }
                                                    ...
                                                    if (GlobalData.itemData != null) {
                                                        ...
                                                        txtPrice.setText(""+Utils.format(additionalPrice) + GlobalData.itemData.currency_symbol);
                                                    }
    ...
    public void bindRate() {
        ...
        try {
            if (GlobalData.itemData != null) {
                ...
                ratingCount.setText(itemRatingCount);
            }
        } catch (Exception e) {
    ...
    private void showFailPopup(String msg) {
        try {
            ...
            if(msg.equalsIgnoreCase(""))
                textMsg.setText(getResources().getString(R.string.like_fail));
            else
                textMsg.setText(msg);
    ...
    private void showRatingFailPopup() {
        try {
            ...
            textMsg.setText(getResources().getString(R.string.rating_fail));
    ...
    private void showRequiredQty() {
        try {
            ...
            textMsg.setText(getResources().getString(R.string.qty_required));
    ...
    private void showRequiredDifferentQty() {
        try {
            ...
            textMsg.setText(getResources().getString(R.string.qty_different_required));
...
//                            overridePendingTransition(R.anim.right_to_left, R.anim.blank_anim);
    ...
    private void doTableSubmit(String postURL, HashMap<String, String> params, final String table_id) {
        ...
        req.setShouldCache(false);
        // add the request object to the queue to be executed
        VolleySingleton.getInstance(DetailActivity.this).addToRequestQueue(req);
    ...
    private void doTableUserDialog() {
        selectPos = 0;
        dialogTableUser = new Dialog(this, R.style.Theme_Dialog);
        ...
        UserAdapter userAdapter = new UserAdapter(DetailActivity.this, tableUserList);
                        ...
                        try {
                            ...
                            if (status.equals(jsonStatusSuccessString)) {
                                ...
                                if (tableUserData != null) {
                                    ...
                                    tableUserList = tableUserData.getData();
