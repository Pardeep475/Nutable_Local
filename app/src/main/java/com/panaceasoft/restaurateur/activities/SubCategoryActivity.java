...
//        mLayoutManager.setGapStrategy(StaggeredGridLayoutManager.GAP_HANDLING_NONE);
        ...
        mLayoutManager = new LinearLayoutManager(SubCategoryActivity.this, LinearLayoutManager.VERTICAL, false);
...
//                                } else {
                                    requestData(Config.APP_API_URL + Config.ITEMS_BY_SUB_CATEGORY + selectedShopID + "/sub_cat_id/" + selectedSubCategoryIndex + "/item/all/count/" + Config.PAGINATION + "/from/" + from + "/field/" + sortField + "/type/" + sortType);
//                                }
//
//                            } else {
...
//            subCategoriesList = categoriesList.get(selectedCategoryIndex-1).sub_categories;
            ...
            Log.e("herecat","herecat"+selectedSubCategoryIndex+" "+selectedCategoryIndex+" "+selectedShopID+" "+fromWhere);
//            if(selectedSubCategoryIndex == 0) {
...
//                } else {
//                    Utils.psLog("4");
//                    requestData(Config.APP_API_URL + Config.ITEMS_BY_SUB_CATEGORY + selectedShopID + "/sub_cat_id/" + selectedCategoryIndex + "/item/all/count/" + Config.PAGINATION + "/form/0/field/" + sortField + "/type/" + sortType);
//                }
//
