...
//            p.shutdown();
    ...
    private void initToolbar() {
        try {
            ...
            txtRecordFound = toolbar.findViewById(R.id.record_found);
            toolbar.setTitle("");
...
//            mLayoutManager = new StaggeredGridLayoutManager(2, StaggeredGridLayoutManager.VERTICAL);
            mLayoutManager = new LinearLayoutManager(SearchResultActivity.this, LinearLayoutManager.VERTICAL, false);
                            ...
                            if (status.equals(jsonStatusSuccessString)) {
                                ...
                                if(myDataSet != null) {
                                    ...
                                    if(it != null) {
                                        ...
                                        String tmpResultCount = it.size()+" Result Found";
